...
export async function POST(req: NextRequest) {
  try {
    ...
    sendMail({
      ...
      subject: `Nuevo recurso descargado: Autodiagnóstico — ${nombre} (${empresa})`,
      html: `
        <h2>Descarga de Autodiagnóstico de Control de Activos</h2>
        <table cellpadding="6" cellspacing="0" border="1" style="border-collapse:collapse;font-family:sans-serif;font-size:14px;">
          ...
          <tr><td>Puntuación</td><td>${totalScore}/24 — Nivel: ${level}</td></tr>
        </table>
      `,
    }).catch((err) => console.error('Error enviando correo de autodiagnóstico:', err));
